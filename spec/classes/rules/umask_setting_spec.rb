      ...
      context "on #{os} with enforce = #{enforce}" do
        ...
        it {
          ...
          if enforce
            ...
            is_expected.not_to contain_file_line('login.defs-usergroups')
            is_expected.not_to contain_file_line('umask-in-bashrc')
            ...
            is_expected.not_to contain_file('/etc/profile.d/set_umask.sh')
            is_expected.not_to contain_file_line('umask in system-auth')
            is_expected.not_to contain_file_line('umask in password-auth')
            is_expected.not_to contain_pam('pam umask system-auth')
            is_expected.not_to contain_pam('pam umask password-auth')
            is_expected.not_to contain_pam('pam umask common-session')
          end
        }
      end
    end
